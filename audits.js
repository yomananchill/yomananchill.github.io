...
const AUDITS = {
  ...
  projects: [
    ...
    { name: "llama.cpp",   langs: ["C++", "C", "Python", "Cuda"],        area: "Inference runtime",   note: "Local LLM serving and model loading" },
    { name: "Redis",       langs: ["C", "Tcl", "Python"],                 area: "In-memory datastore", note: "Core server and loadable modules" },
    { name: "LibreOffice", langs: ["C++", "Java", "Python"],              area: "Document suite",      note: "Office document format handling" },
    { name: "ClamAV",      langs: ["C", "C++", "Rust", "Python"],         area: "Anti-malware",        note: "File format parsing and unpacking" },
    ...
    { name: "Protobuf",    langs: ["C++", "C#", "C", "Java"],             area: "Serialization",       note: "Wire format encoding and decoding" },
    { name: "RE2",         langs: ["C++", "Python"],                      area: "Regex engine",        note: "Linear-time regular expression matching" },
    { name: "Brotli",      langs: ["C", "TypeScript", "C#", "Java"],      area: "Compression",         note: "Codec used across the web platform" },
    { name: "oFono",       langs: ["C"],                                  area: "Telephony",           note: "Modem and cellular stack" },
    { name: "PDFCreator",  langs: ["C#", "JavaScript", "Python"],         area: "PDF tooling",         note: "Document generation and conversion" },
